...
The repo consists of sample Python code to simulate the step by step state vector evolution in Shor's algorithm and Qiskit code to demonstrate Shor's algorithm run on IBM-Q for (N=15, a=7) and (N=15, a=4) using 7 qubits and 5 qubit respectively. This code is part of a project work after completing the course "Introduction to Quantum Computing" - EE225, lectured by professor Hiu Yung Wong at San Jose State University. 
